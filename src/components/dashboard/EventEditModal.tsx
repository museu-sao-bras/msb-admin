...
export function EventEditModal({ open, onClose, event, onSuccess }: Props) {
  ...
  useEffect(() => {
    if (open && event) {
      ...
      setTitle(""); setOrganizerName(""); setOrganizerEmail(""); setOrganizerPhone(""); setDescription(""); setDate(""); setLocation("");
    }
  }, [open, event]);
